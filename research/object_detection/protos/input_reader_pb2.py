...
_INPUTREADER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='load_dense_pose', full_name='object_detection.protos.InputReader.load_dense_pose', index=23,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='load_track_id', full_name='object_detection.protos.InputReader.load_track_id', index=24,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='use_display_name', full_name='object_detection.protos.InputReader.use_display_name', index=25,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='include_source_id', full_name='object_detection.protos.InputReader.include_source_id', index=26,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='input_type', full_name='object_detection.protos.InputReader.input_type', index=27,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='frame_index', full_name='object_detection.protos.InputReader.frame_index', index=28,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='tf_record_input_reader', full_name='object_detection.protos.InputReader.tf_record_input_reader', index=29,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='external_input_reader', full_name='object_detection.protos.InputReader.external_input_reader', index=30,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='sample_from_datasets_weights', full_name='object_detection.protos.InputReader.sample_from_datasets_weights', index=31,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='expand_labels_hierarchy', full_name='object_detection.protos.InputReader.expand_labels_hierarchy', index=32,
